...
## 3.11 Style Settings
设置主题的一个插件，很好用。具体见：[2.1.1 主题](#2.1.1%20主题)。
...
- STEP 2：确定md文档中的链接的地址格式
	- 还记得在[2.1.2 文件与链接](#2.1.2%20文件与链接)当中所说：一定要选md格式的绝对路径吗？
...
- 还是会报错，但是会导出成功，只是格式上会出点问题。如果真的需要word编辑，可以自己修修改改。
	- 我觉得自己打印的话，就用[3.2 Better Export PDF 与 PDF导出](#3.2%20Better%20Export%20PDF%20与%20PDF导出)的方法就好了。
